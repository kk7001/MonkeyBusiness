    ...
    if mode == "usernew":
        ...
        response = E.response(
            E.playerdata_2(
                ...
                E.opt_timing_disp(all_profiles_for_card.get("opt_timing_disp", -1), __type="s32"),
                ...
                *[
                ...
                E.grade(
                    E.single_grade(all_profiles_for_card.get("single_grade", 0), __type="u32"),
                    E.double_grade(all_profiles_for_card.get("double_grade", 0), __type="u32"),
                ),
                # E.golden_league(
        ...
        if int(data.find("isgameover").text) == 0:
            ...
            profile["opt_timing_disp"] = opt_timing_disp
